    ...
    <div class="container-xxl py-5 bg-primary hero-header mb-5">
      <div class="container my-5 py-5 px-lg-5">
        <div class="row g-5 py-5">
          ...
          <div class="col-lg-6 text-center text-lg-start">
            <img class="img-fluid" src="<?= JANG_THEME_IMG ?>/hero.png" alt="">
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-xxl py-5">
    <div class="container px-lg-5">
      <div class="row g-5">
        ...
        <div class="col-lg-6">
          <img class="img-fluid wow zoomIn" data-wow-delay="0.5s" src="<?= JANG_THEME_IMG ?>/about.jpg">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container px-lg-5">
      <div class="row align-items-center" style="height: 250px;">
        ...
        <div class="col-md-6 text-center mb-n5 d-none d-md-block">
          <img class="img-fluid mt-5" style="height: 250px;" src="<?= JANG_THEME_IMG ?>/newsletter.png">
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="owl-carousel testimonial-carousel">
        <div class="testimonial-item bg-transparent border rounded text-white p-4">
          ...
          <div class="d-flex align-items-center">
            <img class="img-fluid flex-shrink-0 rounded-circle" src="<?= JANG_THEME_IMG ?>/testimonial-1.jpg" style="width: 50px; height: 50px;">
            <div class="ps-3">
        ...
        <div class="testimonial-item bg-transparent border rounded text-white p-4">
          ...
          <p>Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
          <div class="d-flex align-items-center">
            <img class="img-fluid flex-shrink-0 rounded-circle" src="<?= JANG_THEME_IMG ?>/testimonial-2.jpg" style="width: 50px; height: 50px;">
            <div class="ps-3">
              <h6 class="text-white mb-1">Client Name</h6>
              <small>Profession</small>
            </div>
        ...
        <div class="testimonial-item bg-transparent border rounded text-white p-4">
          ...
          <p>Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
          <div class="d-flex align-items-center">
            <img class="img-fluid flex-shrink-0 rounded-circle" src="<?= JANG_THEME_IMG ?>/testimonial-3.jpg" style="width: 50px; height: 50px;">
            <div class="ps-3">
              <h6 class="text-white mb-1">Client Name</h6>
              <small>Profession</small>
            </div>
        ...
        <div class="testimonial-item bg-transparent border rounded text-white p-4">
          ...
          <p>Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
          <div class="d-flex align-items-center">
            <img class="img-fluid flex-shrink-0 rounded-circle" src="<?= JANG_THEME_IMG ?>/testimonial-4.jpg" style="width: 50px; height: 50px;">
            <div class="ps-3">
              <h6 class="text-white mb-1">Client Name</h6>
              <small>Profession</small>
            </div>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <div class="team-item">
            <div class="d-flex">
              ...
              <img class="img-fluid rounded w-100" src="<?= JANG_THEME_IMG ?>/team-1.jpg" alt="">
            </div>
            <div class="px-4 py-3">
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
          <div class="team-item">
            <div class="d-flex">
              ...
              <img class="img-fluid rounded w-100" src="<?= JANG_THEME_IMG ?>/team-2.jpg" alt="">
            </div>
            <div class="px-4 py-3">
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
          <div class="team-item">
            <div class="d-flex">
              ...
              <img class="img-fluid rounded w-100" src="<?= JANG_THEME_IMG ?>/team-3.jpg" alt="">
            </div>
            <div class="px-4 py-3">
  ...
  <div class="container-xxl py-5">
    <div class="container px-lg-5">
      <div class="section-title position-relative text-center mb-5 pb-2 wow fadeInUp" data-wow-delay="0.1s">
        ...
        <h2 class="mt-2">Update new blog</h2>
      </div>
